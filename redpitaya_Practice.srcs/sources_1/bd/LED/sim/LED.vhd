...
entity LED is
  ...
  attribute CORE_GENERATION_INFO of LED : entity is "LED,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=LED,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=2,numReposBlks=2,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of LED : entity is "LED.hwdef";
end LED;

architecture STRUCTURE of LED is
  component LED_processing_system7_0_0 is
  port (
  ...
  end component LED_processing_system7_0_0;
  component LED_xlconstant_0_0 is
  port (
    dout : out STD_LOGIC_VECTOR ( 0 to 0 )
  );
  end component LED_xlconstant_0_0;
...
begin
  LED0(0) <= xlconstant_0_dout(0);
processing_system7_0: component LED_processing_system7_0_0
     port map (
...
xlconstant_0: component LED_xlconstant_0_0
     port map (
