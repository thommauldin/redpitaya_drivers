...
-- Date        : Sun May 27 10:03:37 2018
-- Host        : Thomas-Laptop running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               D:/NextLab/Vivado/redpitaya_Practice/redpitaya_Practice.srcs/sources_1/bd/ADC/ip/ADC_Parallel_ADC_Stream_0_0/ADC_Parallel_ADC_Stream_0_0_sim_netlist.vhdl
...
entity ADC_Parallel_ADC_Stream_0_0_Parallel_ADC_Stream_v1_0_M00_AXIS is
  port (
  ...
  attribute ORIG_REF_NAME of ADC_Parallel_ADC_Stream_0_0_Parallel_ADC_Stream_v1_0_M00_AXIS : entity is "Parallel_ADC_Stream_v1_0_M00_AXIS";
end ADC_Parallel_ADC_Stream_0_0_Parallel_ADC_Stream_v1_0_M00_AXIS;

architecture STRUCTURE of ADC_Parallel_ADC_Stream_0_0_Parallel_ADC_Stream_v1_0_M00_AXIS is
  ...
  signal \sample[31]_i_10_n_0\ : STD_LOGIC;
  signal \sample[31]_i_11_n_0\ : STD_LOGIC;
  ...
  signal \start[0]_i_1_n_0\ : STD_LOGIC;
  signal \start_reg_n_0_[0]\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \sample[0]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \sample[31]_i_10\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \start[0]_i_1\ : label is "soft_lutpair1";
begin
...
\sample[0]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"38"
        ...
        port map (
      I0 => m00_axis_aresetn,
      I1 => \stream_data_out[13]_i_2_n_0\,
      I2 => sample(0),
      O => \sample[0]_i_1_n_0\
    );
\sample[31]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"5555555D00000000"
        ...
        port map (
      I0 => m00_axis_aresetn,
      I1 => \sample[31]_i_3_n_0\,
      I2 => \sample[31]_i_4_n_0\,
      I3 => \sample[31]_i_5_n_0\,
      I4 => \sample[31]_i_6_n_0\,
      I5 => \stream_data_out[13]_i_2_n_0\,
      O => \sample[31]_i_1_n_0\
    );
\sample[31]_i_10\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FBFF"
    )
        port map (
...
\sample[31]_i_11\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\sample[31]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0010"
    )
        port map (
...
\sample[31]_i_5\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFF7"
    )
        port map (
...
\sample[31]_i_6\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFEFFFFF"
    )
        port map (
      I0 => \sample[31]_i_10_n_0\,
      I1 => \sample[31]_i_11_n_0\,
      I2 => sample(9),
      I3 => sample(21),
      I4 => sample(3),
      I5 => sample(20),
...
\sample[31]_i_7\: unisim.vcomponents.LUT6
    generic map(
...
\sample[31]_i_8\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFF7"
    )
        port map (
...
\sample[31]_i_9\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\start[0]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"E0"
    )
        port map (
...
\stream_data_out[1]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"EFE0"
        ...
        port map (
      I0 => D1A,
      I1 => \stream_data_out[3]_i_2_n_0\,
      I2 => \stream_data_out[13]_i_2_n_0\,
      I3 => \^m00_axis_tdata\(1),
...
\tx_done[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \sample[31]_i_5_n_0\,
      I2 => \sample[31]_i_4_n_0\,
      I3 => \sample[31]_i_3_n_0\,
      I4 => m00_axis_aresetn,
      I5 => tx_done(0),
      O => \tx_done[0]_i_1_n_0\
    );
\tx_done[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity ADC_Parallel_ADC_Stream_0_0_Parallel_ADC_Stream_v1_0 is
  port (
    m00_axis_tdata : out STD_LOGIC_VECTOR ( 13 downto 0 );
    m00_axis_tvalid : out STD_LOGIC;
    m00_axis_tlast : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of ADC_Parallel_ADC_Stream_0_0_Parallel_ADC_Stream_v1_0 : entity is "Parallel_ADC_Stream_v1_0";
end ADC_Parallel_ADC_Stream_0_0_Parallel_ADC_Stream_v1_0;

architecture STRUCTURE of ADC_Parallel_ADC_Stream_0_0_Parallel_ADC_Stream_v1_0 is
begin
Parallel_ADC_Stream_v1_0_M00_AXIS_inst: entity work.ADC_Parallel_ADC_Stream_0_0_Parallel_ADC_Stream_v1_0_M00_AXIS
     port map (
      D0A => D0A,
      D10A => D10A,
      D11A => D11A,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity ADC_Parallel_ADC_Stream_0_0 is
  port (
    clk_p : in STD_LOGIC;
    clk_n : in STD_LOGIC;
    D0A : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of ADC_Parallel_ADC_Stream_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of ADC_Parallel_ADC_Stream_0_0 : entity is "ADC_Parallel_ADC_Stream_0_0,Parallel_ADC_Stream_v1_0,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of ADC_Parallel_ADC_Stream_0_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of ADC_Parallel_ADC_Stream_0_0 : entity is "Parallel_ADC_Stream_v1_0,Vivado 2017.4";
end ADC_Parallel_ADC_Stream_0_0;

architecture STRUCTURE of ADC_Parallel_ADC_Stream_0_0 is
...
inst: entity work.ADC_Parallel_ADC_Stream_0_0_Parallel_ADC_Stream_v1_0
     port map (
      D0A => D0A,
      D10A => D10A,
      D11A => D11A,
