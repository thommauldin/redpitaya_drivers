...
HD_PWD='D:/NextLab/Vivado/redpitaya_Practice/redpitaya_Practice.runs/DAC_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DAC_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DAC_processing_system7_0_0.tcl
