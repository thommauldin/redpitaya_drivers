...
HD_PWD='D:/NextLab/Vivado/redpitaya_Practice/redpitaya_Practice.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log DAC_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DAC_wrapper.tcl -notrace
