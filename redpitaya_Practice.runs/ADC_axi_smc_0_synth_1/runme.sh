...
HD_PWD='D:/NextLab/Vivado/redpitaya_Practice/redpitaya_Practice.runs/ADC_axi_smc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ADC_axi_smc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ADC_axi_smc_0.tcl
