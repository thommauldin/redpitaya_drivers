...
HD_PWD='D:/NextLab/Vivado/redpitaya_Practice/redpitaya_Practice.runs/DAC_clk_wiz_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DAC_clk_wiz_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DAC_clk_wiz_0.tcl
