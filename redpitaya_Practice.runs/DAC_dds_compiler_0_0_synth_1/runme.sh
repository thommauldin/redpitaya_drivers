...
HD_PWD='D:/NextLab/Vivado/redpitaya_Practice/redpitaya_Practice.runs/DAC_dds_compiler_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DAC_dds_compiler_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DAC_dds_compiler_0_0.tcl
