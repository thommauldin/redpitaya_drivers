...
HD_PWD='D:/NextLab/Vivado/redpitaya_Practice/redpitaya_Practice.runs/ADC_Parallel_ADC_Stream_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ADC_Parallel_ADC_Stream_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ADC_Parallel_ADC_Stream_0_0.tcl
