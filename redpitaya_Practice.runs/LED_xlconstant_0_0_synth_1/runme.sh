...
HD_PWD='D:/NextLab/Vivado/redpitaya_Practice/redpitaya_Practice.runs/LED_xlconstant_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LED_xlconstant_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LED_xlconstant_0_0.tcl
