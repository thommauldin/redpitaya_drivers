...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk_p, clk_n, D0A, D1A, D2A, D3A, D4A, D5A, D6A, D7A, D8A, D9A, 
  D10A, D11A, D12A, D13A, enable, clk_o, m00_axis_tdata, m00_axis_tstrb, m00_axis_tlast, 
  m00_axis_tvalid, m00_axis_tready, m00_axis_aclk, m00_axis_aresetn)
/* synthesis syn_black_box black_box_pad_pin="clk_p,clk_n,D0A,D1A,D2A,D3A,D4A,D5A,D6A,D7A,D8A,D9A,D10A,D11A,D12A,D13A,enable,clk_o,m00_axis_tdata[31:0],m00_axis_tstrb[3:0],m00_axis_tlast,m00_axis_tvalid,m00_axis_tready,m00_axis_aclk,m00_axis_aresetn" */;
  input clk_p;
  input clk_n;
  input D0A;
  input D1A;
