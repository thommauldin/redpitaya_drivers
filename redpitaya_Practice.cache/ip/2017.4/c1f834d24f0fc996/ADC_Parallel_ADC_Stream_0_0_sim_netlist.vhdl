...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Parallel_ADC_Stream_v1_0_M00_AXIS is
  ...
  signal \tx_done[2]_i_6_n_0\ : STD_LOGIC;
  signal \tx_done[2]_i_7_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \sample[31]_i_4\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \stream_data_out[0]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \tx_done[2]_i_5\ : label is "soft_lutpair0";
begin
...
\sample[31]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
\sample[31]_i_6\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
\tx_done[2]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\tx_done[2]_i_5\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000080"
    )
        port map (
...
\tx_done[2]_i_6\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
...
\tx_done[2]_i_7\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
