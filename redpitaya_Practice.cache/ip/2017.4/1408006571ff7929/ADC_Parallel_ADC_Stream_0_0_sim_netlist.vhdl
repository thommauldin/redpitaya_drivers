...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Parallel_ADC_Stream_v1_0_M00_AXIS is
  ...
  attribute SOFT_HLUTNM of \sample[31]_i_11\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \sample[31]_i_4\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \sample[31]_i_9\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \stream_data_out[0]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \tx_done[2]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \tx_done[2]_i_3\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \tx_done[2]_i_5\ : label is "soft_lutpair2";
begin
  clk_o <= \^clk_o\;
...
\sample[31]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
\sample[31]_i_9\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\tx_done[2]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFEFFF"
    )
        port map (
...
\tx_done[2]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"EFFF"
    )
        port map (
